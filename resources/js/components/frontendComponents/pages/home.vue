<template>
    <div class="site-wrapper">
                ...
                <div class="hero-area-content">
                    <div class="container">
                        <div class="row justify-content-center">
                            <div
                                class="col-lg-12 text-center wow fadeInUp animated"
                                data-wow-delay=".2s"
                            >
                                <div class="section-title">
                                    <h1>
                                        short content <b>For this header</b>
                                    </h1>
                    ...
                    <div class="col-lg-6">
                        <div class="about-left">
                            <img
                                ...
                                src="assets/front/img/recycle_home.gif"
                                alt=""
                            />
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="about-content">
                            <div class="section-title">
                                ...
                                <h2>
                                    Sustainable Africa Waste <b>Initiative</b>
                                </h2>
                            </div>
        ...
        <div class="cta-area theme-3">
            <div class="container">
                <div class="row">
                    <div class="col-lg-3"></div>
                    <div class="col-lg-6 text-center">
                        <h2>How can you <b>help</b>?</h2>
                        <p>
...
export default {
    ...
    methods: {
        loadMeals() {
            axios
                .get("/api/sc_front/meals")
                .then(({ data }) => (this.meals = data));
        },
        loadChef() {
            axios
                .get("/api/sc_front/chef")
                .then(({ data }) => (this.chef = data));
        },
        loadTestimonials() {
            axios
