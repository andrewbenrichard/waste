      ...
      <header class="header navbar navbar-expand-sm">
        <ul class="navbar-item theme-brand flex-row text-center">
          <li class="nav-item theme-logo">
            <a href="index.html">
              <img src="/backend/assets/img/logo.svg" class="navbar-logo" alt="logo" />
            </a>
          </li>
        ...
        <ul class="navbar-item flex-row ml-md-auto">
          <li class="nav-item dropdown language-dropdown">
            ...
            <div class="dropdown-menu position-absolute" aria-labelledby="language-dropdown">
              <a class="dropdown-item d-flex" href="javascript:void(0);">
                <img src="/backend/assets/img/de.png" class="flag-width" alt="flag" />
                <span class="align-self-center">&nbsp;German</span>
              </a>
              <a class="dropdown-item d-flex" href="javascript:void(0);">
                <img src="/backend/assets/img/jp.png" class="flag-width" alt="flag" />
                <span class="align-self-center">&nbsp;Japanese</span>
              </a>
              <a class="dropdown-item d-flex" href="javascript:void(0);">
                <img src="/backend/assets/img/fr.png" class="flag-width" alt="flag" />
                    ...
                    <div class="media">
                      <div class="user-img">
                        <img
                          ...
                          src="/backend/assets/img/profile-11.jpg"
                          alt="profile"
                        />
                      </div>
                  ...
                  <div class>
                    <div class="media">
                      <div class="user-img">
                        <img
                          class="usr-img rounded-circle"
                          src="/backend/assets/img/profile-16.jpg"
                          alt="profile"
                        />
                      </div>
                      <div class="media-body">
                  ...
                  <div class>
                    <div class="media">
                      <div class="user-img">
                        <img
                          class="usr-img rounded-circle"
                          src="/backend/assets/img/profile-34.jpg"
                          alt="profile"
                        />
                      </div>
                      <div class="media-body">
          ...
          <li class="nav-item dropdown user-profile-dropdown">
            <a
              ...
              aria-expanded="true"
            >
              <img src="/backend/assets/img/profile-16.jpg" alt="avatar" />
            </a>
